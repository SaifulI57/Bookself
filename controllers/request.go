...
func (db *UserDB) createUser(c *gin.Context) {
...
func (db *BorrowerDB) createBorrower(c *gin.Context) {
...
func (db *PublisherDB) createPubliser(c *gin.Context) {
...
func (db *AuthorDB) createAuthor(c *gin.Context) {
...
func (db *UserDB) getUsers(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		"message": "success",
		"status":  200,
		"data":    db.user,
...
func (db *UserDB) getUserHTTP(c *gin.Context) {
	id := c.Query("id")
...
func (db *BorrowerDB) getBorrowers(c *gin.Context) {
	c.JSON(http.StatusOK, db.borrower)
}

func (db *BorrowerDB) getBorrowerHTTP(c *gin.Context) {
	id := c.Query("id")
...
func (db *PublisherDB) getPublishers(c *gin.Context) {
	c.JSON(http.StatusOK, db.publisher)
}

func (db *PublisherDB) getPublisherHTTP(c *gin.Context) {
	id := c.Query("id")
...
func (db *BookDB) getBooks(c *gin.Context) {
	c.JSON(http.StatusOK, db.book)
}

func (db *BookDB) getBookHTTP(c *gin.Context) {
	id := c.Query("id")
	ids, err := strconv.ParseInt(id, 10, 64)
...
func (db *AuthorDB) getAuthors(c *gin.Context) {
	c.JSON(http.StatusOK, db.author)
}

func (db *AuthorDB) getAuthorHTTP(c *gin.Context) {
	id := c.Query("id")
	ids, err := strconv.ParseInt(id, 10, 64)
...
func (db *UserDB) updateUserHTTP(c *gin.Context) {
	id := c.Query("id")
...
func (db *BorrowerDB) updateBorrowerHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *PublisherDB) updatePublisherHTTP(c *gin.Context) {
	id := c.Query("id")
	if id == "" {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *BookDB,) updateBookHTTP(c *gin.Context) {
	id := c.Query("id")
...
func (db *AuthorDB) updateAuthorHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *AuthorDB) deleteAuthorHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *BookDB) deleteBookHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *PublisherDB) deletePublisherHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *BorrowerDB) deleteBorrowerHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
...
func (db *UserDB) deleteUserHTTP(c *gin.Context) {
	id := c.Query("id")
	idInt, err := strconv.ParseInt(id, 10, 64)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{
